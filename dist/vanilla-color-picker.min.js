...
//
// ============================================================
!function(e){function t(e,t,i){return'<div class="vanilla-color-picker-single-color '+(i?"vanilla-color-picker-single-color-picked":"")+'" tabindex="'+t+'" data-color="'+e+'" style="background-color:'+e+'"></div>'}function i(){if(!document.getElementById("vanilla-color-picker-style")){var t=document.createElement("style")
...
this.elem.addEventListener("click",function(t){t.target.classList.contains("vanilla-color-picker-single-color")&&e.emit("colorChosen",t.target.dataset.color)}),this.elem.addEventListener("keydown",function(t){var i=t.which||t.keyCode
13==i&&e.emit("colorChosen",t.target.dataset.color),27==i&&e.emit("lostFocus")})},this._initialize()}function o(e){n.apply(this),this.set=this.emit,this.colors=c,this.className="",this.elem=e,this.currentPicker=null
var t=this
